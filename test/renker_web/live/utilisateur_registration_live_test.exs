defmodule RenkerWeb.UtilisateurRegistrationLiveTest do
  ...
  describe "Registration page" do
    ...
    test "renders errors for invalid data", %{conn: conn} do
      ...
      result =
        ...
        |> render_change(utilisateur: %{"email" => "with spaces", "password" => "too short"})
  ...
  describe "register utilisateur" do
    test "creates account and logs the utilisateur in", %{conn: conn} do
      {:ok, lv, _html} = live(conn, ~p"/utilisateurs/register")
    ...
    test "renders errors for duplicated email", %{conn: conn} do
      ...
      result =
        ...
        |> form("#registration_form",
          utilisateur: %{"email" => utilisateur.email, "password" => "valid_password"}
        )
        |> render_submit()
